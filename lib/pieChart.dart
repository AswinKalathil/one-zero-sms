...
class MyRadarChart extends StatefulWidget {
  ...
  const MyRadarChart({
    ...
    this.outlineColor = const Color.fromARGB(255, 206, 74, 74),
    this.axisColor = Colors.grey,
    this.graphColors = defaultGraphColors,
    this.sides = 0,
  }) : super(key: key);

  factory MyRadarChart.light({
  ...
  @override
  _MyRadarChartState createState() => _MyRadarChartState();
}
...
class _MyRadarChartState extends State<MyRadarChart>
  ...
  @override
  void didUpdateWidget(MyRadarChart oldWidget) {
